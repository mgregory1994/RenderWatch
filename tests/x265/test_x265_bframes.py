...
class TestX265BFrames(unittest.TestCase):
    """Tests all B-Frames option values for the X265 codec."""
    ...
    def _test_bframes_normal_values(self, x265):
    ...
    def _test_bframes_abnormal_values(self, x265):
