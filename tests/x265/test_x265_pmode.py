...
class TestX265PMode(unittest.TestCase):
    """Tests all PMode option values for the x265 codec."""
    ...
    def _test_pmode_normal_values(self, x265):
        # Values that sould apply.
        x265.pmode = True
        self.assertTrue(x265.pmode)
        x265.pmode = False
        self.assertFalse(x265.pmode)

    def _test_pmode_abormal_values(self, x265):
