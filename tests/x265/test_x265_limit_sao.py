...
class TestX265LimitSAO(unittest.TestCase):
    """Tests all Limit SAO option values for the x265 codec."""
    ...
    def _test_limit_sao_normal_values(self, x265):
        # Values that sould apply.
        x265.limit_sao = True
        self.assertTrue(x265.limit_sao)
        x265.limit_sao = False
        self.assertFalse(x265.limit_sao)

    def _test_limit_sao_abormal_values(self, x265):
