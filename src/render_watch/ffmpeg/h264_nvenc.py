...
class H264Nvenc:
    """Manages all settings for the H264 NVENC codec."""

    OPTIONS = NvidiaHelper.get_h264_nvenc_options()
    ...
    if '-multipass' in OPTIONS:
        MULTI_PASS_ARGS_LIST = OPTIONS['-multipass']
    MULTI_PASS_LIST_LENGTH = len(MULTI_PASS_ARGS_LIST)
    CODER_ARGS_LIST = ['auto']
    if '-coder' in OPTIONS:
        CODER_ARGS_LIST = OPTIONS['-coder']
    ...
    def qp_i(self, qp_i_value):
        """Stores qp i value as a string argument."""
    ...
    def qp_p(self, qp_p_value):
        """Stores qp p value as a string argument."""
    ...
    @property
    def qp_b(self):
        """Return init qpB argument as a float."""
    ...
    def qp_b(self, qp_b_value):
        """Stores qp b value as a string argument."""
    ...
    @property
    def b_adapt(self):
        """Returns b adapt argument as a boolean."""
    ...
    def b_adapt(self, b_adapt_enabled):
        """Stores b adapt boolean as a string argument."""
    ...
    @property
    def coder(self):
        """Returns coder argument as an index."""
