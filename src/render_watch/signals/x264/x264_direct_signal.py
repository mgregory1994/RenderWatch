...
class X264DirectSignal:
    ...
    def on_x264_direct_combobox_changed(self, x264_direct_combobox):
        """
        Applies the Direct option and updates the preview page.

        :param x264_direct_combobox: Combobox that emitted the signal.
        """
        if self.x264_handlers.is_widgets_setting_up:
            return

        direct_index = x264_direct_combobox.get_active()
