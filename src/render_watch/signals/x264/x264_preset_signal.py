...
class X264PresetSignal:
    ...
    def on_x264_preset_combobox_changed(self, x264_preset_combobox):
        """
        Applies the Preset option and updates the preview page.

        :param x264_preset_combobox: Combobox that emitted the signal.
        """
        if self.x264_handlers.is_widgets_setting_up:
            return

        preset_index = x264_preset_combobox.get_active()
