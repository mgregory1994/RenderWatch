...
class PrefsHandlers:
    def __init__(self, gtk_builder, gtk_settings, main_window_handlers, preferences):
        ...
        self.prefs_clear_signal = PrefsClearSignal(self, main_window_handlers, preferences,
        ...
        self.prefs_temp_chooser_signal = PrefsTempChooserSignal(self, main_window_handlers, preferences,
                                                                self.original_temp_directory)
        self.prefs_wait_for_tasks_signal = PrefsWaitForTasksSignal(preferences)
        self.signals_list = (self.prefs_clear_signal, self.prefs_concurrent_signal, self.prefs_dark_theme_signal,
