...
from render_watch.signals.x265.x265_refs_signal import X265RefsSignal
...
class X265Handlers:
    ...
    def _setup_signals(self, inputs_page_handlers, application_preferences):
        ...
        self.ref_signal = X265RefsSignal(self, inputs_page_handlers)
    ...
    def _setup_widgets(self, gtk_builder):
        ...
        self.x265_hevc_aq_checkbutton = gtk_builder.get_object('x265_hevc_aq_checkbutton')
        ...
        self.x265_refs_spinbutton = gtk_builder.get_object('x265_refs_spinbutton')
        ...
        self.x265_b_intra_checkbutton = gtk_builder.get_object('x265_b_intra_checkbutton')
        self.x265_closed_gop_checkbutton = gtk_builder.get_object('x265_closed_gop_checkbutton')
        self.x265_rc_lookahead_spinbutton = gtk_builder.get_object('x265_rc_lookahead_spinbutton')
        self.x265_no_scenecut_checkbutton = gtk_builder.get_object('x265_no_scenecut_checkbutton')
        self.x265_no_high_tier_checkbutton = gtk_builder.get_object('x265_no_high_tier_checkbutton')
    ...
    def _apply_advanced_settings(self, video_settings):
        if self.x265_advanced_settings_switch.get_active():
            ...
            video_settings.hevc_aq = self.x265_hevc_aq_checkbutton.get_active()
            ...
            video_settings.ref = self.x265_refs_spinbutton.get_value_as_int()
            ...
            video_settings.b_intra = self.x265_b_intra_checkbutton.get_active()
            video_settings.no_open_gop = self.x265_closed_gop_checkbutton.get_active()
            video_settings.rc_lookahead = self.x265_rc_lookahead_spinbutton.get_value_as_int()
            video_settings.no_scenecut = self.x265_no_scenecut_checkbutton.get_active()
            video_settings.no_high_tier = self.x265_no_high_tier_checkbutton.get_active()
    ...
    def _setup_x265_advanced_settings_widgets(self, video_settings):
        ...
        self.x265_hevc_aq_checkbutton.set_active(video_settings.hevc_aq)
        ...
        self.x265_refs_spinbutton.set_value(video_settings.ref)
        ...
        self.x265_b_intra_checkbutton.set_active(video_settings.b_intra)
        self.x265_closed_gop_checkbutton.set_active(video_settings.no_open_gop)
        self.x265_rc_lookahead_spinbutton.set_value(video_settings.rc_lookahead)
        self.x265_no_scenecut_checkbutton.set_active(video_settings.no_scenecut)
        self.x265_no_high_tier_checkbutton.set_active(video_settings.no_high_tier)
    ...
    def _reset_advanced_settings_widgets(self):
        ...
        self.x265_b_intra_checkbutton.set_active(False)
        self.x265_closed_gop_checkbutton.set_active(False)
        self.x265_rc_lookahead_spinbutton.set_value(20)
        self.x265_no_scenecut_checkbutton.set_active(False)
        self.x265_no_high_tier_checkbutton.set_active(False)
