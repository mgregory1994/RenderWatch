...
from render_watch.signals.x264.x264_b_adapt_signal import X264BAdaptSignal
from render_watch.signals.x264.x264_b_frames_signal import X264BFramesSignal
from render_watch.signals.x264.x264_bitrate_signal import X264BitrateSignal
from render_watch.signals.x264.x264_b_pyramid_signal import X264BPyramidSignal
...
from render_watch.signals.x264.x264_psy_rd_signal import X264PsyRDSignal
...
from render_watch.signals.x264.x264_weight_b_signal import X264WeightBSignal
from render_watch.signals.x264.x264_weight_p_signal import X264WeightPSignal
...
class X264Handlers:
    ...
    def __init__(self, gtk_builder, inputs_page_handlers, application_preferences):
        ...
        self.x264_advanced_settings_signal = X264AdvancedSettingsSignal(self)
        self.x264_aq_signal = X264AqSignal(self, inputs_page_handlers)
        self.x264_b_adapt_signal = X264BAdaptSignal(self, inputs_page_handlers)
        self.x264_b_frames_signal = X264BFramesSignal(self, inputs_page_handlers)
        self.x264_bitrate_signal = X264BitrateSignal(self, inputs_page_handlers, application_preferences)
        self.x264_b_pyramid_signal = X264BPyramidSignal(self, inputs_page_handlers)
        ...
        self.x264_no_fast_p_skip_signal = X264NoFastPSkipSignal(self, inputs_page_handlers)
        ...
        self.x264_psy_rd_signal = X264PsyRDSignal(self, inputs_page_handlers)
        ...
        self.x264_weight_b_signal = X264WeightBSignal(self, inputs_page_handlers)
        self.x264_weight_p_signal = X264WeightPSignal(self, inputs_page_handlers)
        self.signals_list = (
            self.x264_8x8dct_signal, self.x264_advanced_settings_signal, self.x264_aq_signal,
            self.x264_b_adapt_signal, self.x264_b_frames_signal, self.x264_bitrate_signal,
            self.x264_b_pyramid_signal, self.x264_crf_signal, self.x264_deblock_signal,
            ...
            self.x264_no_fast_p_skip_signal, self.x264_partitions_signal, self.x264_preset_signal,
            self.x264_profile_signal, self.x264_psy_rd_signal, self.x264_qp_signal,
            self.x264_refs_signal, self.x264_trellis_signal, self.x264_tune_signal,
            self.x264_vbv_signal, self.x264_weight_p_signal, self.x264_weight_b_signal
        )
        ...
        self.x264_2_pass_radiobutton = gtk_builder.get_object('x264_2_pass_radiobutton')
        ...
        self.x264_vbv_maxrate_spinbutton = gtk_builder.get_object('x264_vbv_maxrate_spinbutton')
        ...
        self.x264_subme_combobox = gtk_builder.get_object('x264_subme_combobox')
        ...
        self.x264_i8x8_checkbutton = gtk_builder.get_object('x264_i8x8_checkbutton')
        self.x264_i4x4_checkbutton = gtk_builder.get_object('x264_i4x4_checkbutton')
        self.x264_p8x8_checkbutton = gtk_builder.get_object('x264_p8x8_checkbutton')
        self.x264_p4x4_checkbutton = gtk_builder.get_object('x264_p4x4_checkbutton')
        self.x264_b8x8_checkbutton = gtk_builder.get_object('x264_b8x8_checkbutton')
        self.x264_8x8dct_checkbutton = gtk_builder.get_object('x264_8x8dct_checkbutton')
    ...
    def _apply_bitrate_settings(self, video_settings):
        ...
        if self.x264_constant_radiobutton.get_active():
            ...
            video_settings.vbv_maxrate = self.x264_vbv_maxrate_spinbutton.get_value_as_int()
    ...
    def set_settings(self, ffmpeg_param=None):
        """
        Configures the x264 widgets to match the selected task's ffmpeg settings.
        """
    ...
    def _setup_x264_advanced_settings_widgets(self, video_settings):
        ...
        self.x264_vbv_maxrate_spinbutton.set_value(video_settings.vbv_maxrate)
    ...
    def _setup_x264_partitions_widgets(self, video_settings):
        if video_settings.partitions:
            ...
            self._set_custom_partitions_settings(video_settings)
        else:
            self._set_auto_partitions_settings()

    def _set_custom_partitions_settings(self, video_settings):
    ...
    def reset_settings(self):
        """
        Resets the x264 widgets to their default values.
        """
        self.is_widgets_setting_up = True
    ...
    def _reset_advanced_settings_widgets(self):
        ...
        self.x264_vbv_maxrate_spinbutton.set_value(2500)
    ...
    def set_crf_state(self):
        ...
        self.x264_vbv_maxrate_spinbutton.set_sensitive(False)
    ...
    def set_vbr_state(self, enabled):
        self.x264_vbv_maxrate_spinbutton.set_sensitive(enabled)
    ...
    def update_vbr(self):
        ...
        if bitrate_value > self.x264_vbv_maxrate_spinbutton.get_value_as_int():
            self.x264_vbv_maxrate_spinbutton.set_value(bitrate_value)
        else:
            self.on_x264_vbv_max_rate_spinbutton_value_changed(self.x264_vbv_maxrate_spinbutton)
