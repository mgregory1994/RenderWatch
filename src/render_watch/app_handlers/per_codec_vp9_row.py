...
class PerCodecVp9Row(Gtk.ListBoxRow):
    """
    Creates a Gtk.ListboxRow for the per codec vp9 option in the Application Preferences Dialog.
    """
    ...
    def _setup_widgets(self, application_preferences):
        ...
        self.per_codec_combobox.connect('changed',
                                        self.per_codec_parallel_tasks_signal.on_per_codec_vp9_combobox_changed)
