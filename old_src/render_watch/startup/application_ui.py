...
class ApplicationUI:
    ...
    def _setup_video_container_widgets(self):
        ...
        UIHelper.setup_combobox(container_combobox, GeneralSettings.CONTAINERS_UI)
    ...
    def _setup_video_codec_widgets(self):
        ...
        if NvidiaHelper.is_nvenc_supported():
            video_codec_list = GeneralSettings.VIDEO_CODECS_MP4_NVENC_UI
        else:
            video_codec_list = GeneralSettings.VIDEO_CODECS_MP4_UI
    ...
    def _setup_audio_codec_widgets(self):
        ...
        UIHelper.setup_combobox(audio_codec_combobox, GeneralSettings.AUDIO_CODECS_MP4_UI)

    def _setup_frame_rate_widgets(self):
        fps_combobox = self.gtk_builder.get_object("fps_combobox")
        UIHelper.setup_combobox(fps_combobox, GeneralSettings.FRAME_RATES)
    ...
    def _setup_vp9_quality_widgets(self):
        ...
        UIHelper.setup_combobox(vp9_quality_combobox, VP9.QUALITY)

    def _setup_vp9_speed_widgets(self):
        vp9_speed_combobox = self.gtk_builder.get_object('vp9_speed_combobox')
        UIHelper.setup_combobox(vp9_speed_combobox, VP9.SPEED)
    ...
    def _setup_aac_channels_widgets(self):
        ...
        UIHelper.setup_combobox(aac_channels_combobox, Aac.CHANNELS_UI)
    ...
    def _setup_opus_channels_widgets(self):
        ...
        UIHelper.setup_combobox(opus_channels_combobox, Opus.CHANNELS_UI)
