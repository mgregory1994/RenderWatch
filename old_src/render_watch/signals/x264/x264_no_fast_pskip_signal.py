...
class X264NoFastPSkipSignal:
    ...
    def on_x264_no_fast_pskip_checkbutton_toggled(self, x264_no_fast_pskip_checkbutton):
        """
        Applies the No Fast PSkip option and updates the preview page.

        :param x264_no_fast_pskip_checkbutton: Checkbutton that emitted the signal.
        """
        ...
        for row in self.inputs_page_handlers.get_selected_rows():
            ffmpeg = row.ffmpeg
            ffmpeg.video_settings.no_fast_pskip = x264_no_fast_pskip_checkbutton.get_active()
