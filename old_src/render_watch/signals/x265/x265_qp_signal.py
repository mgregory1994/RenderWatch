...
class X265QpSignal:
    ...
    def on_x265_qp_radiobutton_clicked(self, x265_qp_radiobutton):
        """
        Applies the QP option, configures the x265 widgets for QP, and updates the preview page.

        :param x265_qp_radiobutton: Radiobutton that emitted the signal.
        """
        if not x265_qp_radiobutton.get_active():
            return
